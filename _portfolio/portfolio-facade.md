...
<div style="border-left: 3px solid #e2e8f0; padding-left: 15px; margin-bottom: 30px; color: #64748b; font-size: 0.9rem; line-height: 1.6;">
  ...
  <a href="https://bilab.engineering.nyu.edu/projects/cv-based-defects" target="_blank" style="color: #1a4471; text-decoration: none; font-weight: 500;" onmouseover="this.style.color='#e74c3c'" onmouseout="this.style.color='#1a4471'">
    BiLAB (Built Environment Innovation Lab)
  </a> project at NYU <br>
